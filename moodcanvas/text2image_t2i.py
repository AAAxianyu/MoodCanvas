...
class ImageGenerator:
    ...
    def __init__(self, config_manager):
        ...
        self.api_key = os.environ.get(api.get("api_key_env", "ARK_API_KEY")) or config_manager.get_secret("doubao_api_key_env")
        if not self.api_key:
            raise RuntimeError("未设置 ARK_API_KEY，请先 export ARK_API_KEY=你的密钥")

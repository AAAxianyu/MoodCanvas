...
class TestMockServices:
    ...
    def test_mock_emotion_analyzer_structure(self):
        ...
        mock_config.config = {
            ...
            "models": {
                "emotion2vec": {"local_path": "src/data/models/emotion2vec"},
                "paraformer": {"local_path": "src/data/models/paraformer"},
                "text_emotion": {"local_path": "src/data/models/text_emotion"}
            }
        }

...
class TestConfigManager:
    ...
    def test_get_model_path(self, config_manager):
        ...
        assert emotion2vec_path == "src/data/models/emotion2vec_plus_large"
        
        paraformer_path = config_manager.get_model_path("paraformer")
        assert paraformer_path == "src/data/models/paraformer-zh"
    ...
    def test_setup_environment(self, config_manager):
        ...
        assert os.environ["HF_HOME"] == "src/data/models"
        assert os.environ["MODELSCOPE_CACHE"] == "src/data/models"
